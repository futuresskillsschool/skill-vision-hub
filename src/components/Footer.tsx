        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-foreground/70 text-sm mb-6">
              Empowering students to discover their unique strengths and interests through scientifically-validated assessments, helping them make informed decisions about their educational and career paths.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-brand-purple/10 hover:bg-brand-purple/20 flex items-center justify-center transition-colors" aria-label="LinkedIn">
                <svg className="w-4 h-4 text-brand-purple" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-brand-purple/10 hover:bg-brand-purple/20 flex items-center justify-center transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 text-brand-purple" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-foreground/60 mb-4 md:mb-0">
              © {currentYear} Future Skills School. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link to="/privacy" className="text-sm text-foreground/60 hover:text-brand-purple transition-colors">
                Privacy Policy
              </Link>
